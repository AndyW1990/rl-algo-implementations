# -*- coding: utf-8 -*-
"""
Created on Fri Feb 12 08:39:44 2021
...
class Agent:
    ...
    def remember(self, state, action, probs, vals, rewards, dones):
        self.memory.store_memory(state, action, probs, vals, rewards, dones)
